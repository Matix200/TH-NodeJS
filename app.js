    ...
    if (!error && response.statusCode == 200) {
     ...
     // console.log(info);
      ...
      for(var i in info){
      	...
      	if(metadata.image == (null || undefined )) {var image = "null" }else{var image = metadata.image;}
      	if(metadata.description == (null || undefined)) {var description = "null" }else{var description = metadata.description;}
  		ArrayNews.push({
  			"ID" : info[i].id,
